...
export function RandomChatModal({ open, onClose }: RandomChatModalProps) {
  ...
  return (
    <div
      className="pointer-events-none fixed inset-x-0 z-[45] flex items-center justify-center overflow-hidden px-3 py-[calc(env(safe-area-inset-top)+14px)] md:items-end md:justify-end md:px-6 md:py-6"
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[15px] md:text-base font-semibold truncate">커뮤니티</p>
